...
export const AshesOfWarScreen = () => {
    ...
    const [textSearch, setTextSearch] = useState<string>("")
     ...
     const calculateCompletion = (value: CommonItem, itemId: number) => {
      ...
      const itemIndex = collectedItems.findIndex(element => element.id === itemId)
    ...
    return(
        <SafeAreaView style={styles.screenContainer}>
          ...
          <View style={styles.searchContainer}>
            ...
            <TextInput placeholder="Type to search on the page" style={styles.textInput} onChangeText={(text: string) => {
                setTextSearch(text)
