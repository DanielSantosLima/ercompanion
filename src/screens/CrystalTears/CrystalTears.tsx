...
export const CrystalTearsScreen = () => {
    const [totalCompletion, setTotalCompletion] = useState<number>(0);
    const [collectedItems, setCollectedItems] = useState<CommonItem[]>(crystalTears);
    const [filteredItems, setFilteredItems] = useState<CommonItem[]>(crystalTears);
    ...
    const onItemClick = (id: number, checked: boolean) => {
        // Find the clicked item from the filteredItems array based on the id
        ...
        <SafeAreaView style={styles.screenContainer}>
            <ScrollView style={styles.scrollView}>
                <View style={styles.circularProgressContainer}>
                    <Text style={styles.progressTitle}>Crystal Tears Collected</Text>
                    <CircularProgress
